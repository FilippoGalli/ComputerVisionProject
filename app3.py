...
def main():
    ...
    if create:
        ...
        np.save('./data/output/app3/R', R)
        np.save('./data/output/app3/T', T)
        np.save('./data/output/app3/error_model', error)
        ...
        o3d.io.write_point_cloud('./data/output/app3/pcd_roto.ply', pcd_roto)
...
def loadScene():
    ...
    R = np.load('./data/output/app3/R.npy')
    T = np.load('./data/output/app3/T.npy')
    error = np.load('./data/output/app3/error_model.npy')
