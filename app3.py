...
def main():
    ...
    print('Load data')
    pcd1, pcd2, keypoints_indices_pcd1, keypoints_indices_pcd2, saliency_pcd1, saliency_pcd2, sigma_pcd1, sigma_pcd2, descriptor_list_pcd1, descriptor_list_pcd2, matching_indices   = loadScene()
    ...
    data = [matching_indices, pcd1_points[keypoints_indices_pcd1], pcd2_points[keypoints_indices_pcd2]]

    model, error = computeRANSAC(data)
    ...
    pcd1.points = o3d.utility.Vector3dVector(p_estimate)
    ...
    pcd1_keypoints.paint_uniform_color([1.0, 0.0, 0.0])
    ...
    o3d.visualization.draw_geometries([rf, pcd1_keypoints, pcd2_keypoints, pcd2, pcd1, lines])
...
def loadScene():
    ...
    return [pcd1, pcd2, keypoints_indices_pcd1, keypoints_indices_pcd2, saliency_pcd1, saliency_pcd2, sigma_pcd1, sigma_pcd2, descriptor_list_pcd1, descriptor_list_pcd2, matching_indices]
